...
window.QuestionBanksGenerated.junior.chinese = [
  ...
  { type: 'single', section: "語文素養", text: "下列何者標點符號使用正確？", options: ["他問：「你好吗？」","他問，「你好吗」？","他問：「你好吗」？","他問，「你好吗？」"], answer: 0, explanation: "本題為 202609 年 語文素養 自動更新題。" },

  { type: 'single', section: "字音字形", text: "「一曝十寒」的「曝」讀音為何？", options: ["ㄆㄨˋ","ㄅㄠˋ","ㄆㄡˋ","ㄅㄨˋ"], answer: 0, explanation: "本題為 202609 年 字音字形 自動更新題。" },

  { type: 'single', section: "成語", text: "「破釜沉舟」表現什麼？", options: ["背水一戰的決心","烹飪技術","節約用水","優柔寡斷"], answer: 0, explanation: "本題為 202609 年 成語 自動更新題。" },
  ...
  { type: 'single', section: "成語", text: "「亡羊補牢」的寓意為何？", options: ["及時補救還不算晚","羊已經丟了","不必修補","等待機會"], answer: 0, explanation: "本題為 202609 年 成語 自動更新題。" },
