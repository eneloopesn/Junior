...
window.QuestionBanksGenerated.gsat.chinese = [
  {
    ...
    questions: [
      { text: "「高處不勝寒」表現詞人什麼心理？（#1337228253-0-0）", options: ["對月無興趣","想上天又怕冷，內心矛盾","非常想飛","完全不想回人間"], answer: 1, explanation: "依據題幹與文意判斷，答案為選項 1。" },
      { text: "「但願人長久，千里共嬋娟」表達什麼？（#1337228253-0-1）", options: ["對遠方親人的祝福","對離別的怨恨","對月的讚美","對人生的失望"], answer: 0, explanation: "依據題幹與文意判斷，答案為選項 1。" },
      { text: "「此事古難全」的「此事」指什麼？（#1337228253-0-2）", options: ["飲酒與作詩","上天與人間","風與雨","人的離合與月的圓缺"], answer: 3, explanation: "依據題幹與文意判斷，答案為選項 1。" },
      { text: "全詞的風格為何？（#1337228253-0-3）", options: ["只寫自然","完全悲觀","豁達中有深情","純粹諷刺"], answer: 2, explanation: "依據題幹與文意判斷，答案為選項 1。" }
    ]
  },

  {
    type: 'group', section: "閱讀理解",
    passage: "<p>臺灣（題組70）傳統建築中，閩南式建築講究裝飾，屋脊剪黏、交趾陶色彩繽紛；客家建築則注重防禦，土樓厚實堅固，展現團結互助精神。</p><p>近年文資保存意識興起，老屋再生讓傳統建築在現代生活中找到新定位。</p>",
    questions: [
      { text: "閩南式與客家建築的主要差異？（#1337228253-1-0）", options: ["客家用石材","閩南重裝飾，客家重防禦","兩者相同","閩南在北部"], answer: 1, explanation: "依據題幹與文意判斷，答案為選項 1。" },
      { text: "「剪黏」屬於哪種建築特色？（#1337228253-1-1）", options: ["閩南式","原住民","日式","客家"], answer: 0, explanation: "依據題幹與文意判斷，答案為選項 1。" },
      { text: "「老屋再生」的意義？（#1337228253-1-2）", options: ["只供觀光","全部拆除","禁止進入","讓傳統建築在現代找到新用途"], answer: 3, explanation: "依據題幹與文意判斷，答案為選項 1。" }
    ]
  },
